    ...
    try {
      ...
      tranEmailApi
        .sendTransacEmail({
          ...
          htmlContent: `Click on the link below to reset password <br> <a href="http://34.238.151.86:3000/password/resetpassword/${forgotPasswordRecord.id}">Reset password</a>`,
        })
        .then((response) => {
